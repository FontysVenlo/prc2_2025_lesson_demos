...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Number of days till holiday - 18 July
        System.out.println("\n==== How long till holidays?");
        LocalDate holidays = LocalDate.of(2025, Month.JULY, 18);
        ...
        LocalDate beginningNextYear = LocalDate.of(2025, Month.JANUARY, 1);
        LocalDate endNextYear = LocalDate.of(2025, Month.DECEMBER, 31);
